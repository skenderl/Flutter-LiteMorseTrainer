...
class NumbersTutorial extends StatefulWidget {
  NumbersTutorial({Key key}) : super(key: key);

  _NumbersTutorialState createState() => _NumbersTutorialState();
}

class _NumbersTutorialState extends State<NumbersTutorial> {
  AudioCache cache;
  Size mySize;
  bool firstTime = true;
  ...
  Map<String, bool> currentProgress =
      Map.fromIterables(List.from(numbers), List.filled(10, false));
